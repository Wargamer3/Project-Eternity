...
{
    public class EmptyBoxScrollbar: IUIElement
    {
        ...
        public EmptyBoxScrollbar(Vector2 Position, int Height, float ScrollbarValueMax, OnScrollbarChangeDelegate OnScrollbarChange)
        {
        ...
        {
            GameScreen.DrawBox(g, Position, Width, SectionSize, Color.FromNonPremultiplied(255, 255, 255, 0));
        }

        private void DrawBottomArrow(CustomSpriteBatch g)
        {
            GameScreen.DrawBox(g, new Vector2(Position.X, Position.Y + Height - SectionSize), Width, SectionSize, Color.FromNonPremultiplied(255, 255, 255, 0));
        }

        private void DrawScrollbarBar(CustomSpriteBatch g)
        {
            GameScreen.DrawBox(g, new Vector2(Position.X, ScrollbarBarPositionY), Width, SectionSize, Color.FromNonPremultiplied(255, 255, 255, 0));
        }
