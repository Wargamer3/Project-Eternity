...
{
    public sealed class CollisionObject2D<T> where T : class, ICollisionObjectHolder2D<T>
    {
        public List<Polygon> ListCollisionPolygon;
        public LinkedList<CollisionZone2D<T>> ListParent;
        ...
        public CollisionObject2D()
        {
            ...
            ListParent = new LinkedList<CollisionZone2D<T>>();
        }

        public CollisionObject2D(Vector2[] ArrayVertex, int MaxWidth, int MaxHeight)
        {
