    ...
    public partial class ProjectEternityTilesetPresetEditor : BaseEditor
    {
        ...
        public override EditorInfo[] LoadEditors()
        {
            EditorInfo[] Info = new EditorInfo[]
            {
                ...
                new EditorInfo(new string[] { GUIRootPathMapTilesetPresetsDeathmatch, GUIRootPathMapTilesetPresets, GUIRootPathMapTilesets }, "Tileset Presets/Deathmatch", new string[] { ".pet" }, typeof(ProjectEternityTilesetPresetEditor), true)
            };
