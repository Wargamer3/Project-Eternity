...
namespace ProjectEternity.Editors.CharacterSpiritEditor
{
    public partial class ProjectEternityCharacterSpiritEditor : BaseEditor
    {
        ...
        public override EditorInfo[] LoadEditors()
        {
            ...
            {
                new EditorInfo(new string[] { GUIRootPathCharacterSpirits }, "Characters/Spirits/", new string[] { ".pecs" }, typeof(ProjectEternityCharacterSpiritEditor), true, null, true)
            };
