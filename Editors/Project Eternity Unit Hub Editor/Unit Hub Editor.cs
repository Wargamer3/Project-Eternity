...
namespace ProjectEternity.Editors.UnitHubEditor
{
    public partial class UnitHubEditor : BaseEditor
    {
        ...
        public override EditorInfo[] LoadEditors()
        {
            ...
            {
                new EditorInfo(new string[] { GUIRootPathUnitsHub, GUIRootPathUnits }, "Units/Hub/", new string[] { ".peu" }, typeof(UnitHubEditor))
            };
        ...
        private void LoadUnit(string UnitPath)
        {
            ...
            UnitHub NewUnit = new UnitHub(Name, null, DicUnitType, DicRequirement, DicEffect, DicAutomaticSkillTarget);
