...
namespace ProjectEternity.Editors.LifeSimCharacterEditor
{
    public partial class DetailsEditor : Form
    {
        ...
        private void btnChangeShopSprite_Click(object sender, EventArgs e)
        {
            ...
            ListMenuItemsSelected(EditorHelper.ShowContextMenuWithItem(EditorHelper.GUIRootPathLifeSimPortraitSprites));
        }

        private void btnChangeMapSprite_Click(object sender, EventArgs e)
        {
            ItemSelectionChoice = ItemSelectionChoices.MapSprite;
            ListMenuItemsSelected(EditorHelper.ShowContextMenuWithItem(EditorHelper.GUIRootPathLifeSimMapSprites));
        }

        private void btnChange3DModel_Click(object sender, EventArgs e)
        {
            ItemSelectionChoice = ItemSelectionChoices.Model;
            ListMenuItemsSelected(EditorHelper.ShowContextMenuWithItem(EditorHelper.GUIRootPathLifeSimCharacterModels));
        }
