...
{
    class LifeSimTilesetTab : MapEditor.TilesetTab
    {
        ...
        protected override void btnAddTile_Click(object sender, EventArgs e)
        {
            ...
            ListMenuItemsSelected(EditorHelper.ShowContextMenuWithItem(EditorHelper.GUIRootPathMapTilesetPresetsLifeSim));
        }

        protected override void btnAddAutotile_Click(object sender, EventArgs e)
        {
            ItemSelectionChoice = ItemSelectionChoices.Autotile;
            ListMenuItemsSelected(EditorHelper.ShowContextMenuWithItem(EditorHelper.GUIRootPathMapAutotilesPresetsLifeSim));
        }
    }
}
