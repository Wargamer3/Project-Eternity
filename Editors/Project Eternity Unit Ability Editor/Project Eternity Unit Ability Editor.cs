...
{
    public partial class ProjectEternityUnitAbilityEditor : BaseEditor
    {
        ...
        public ProjectEternityUnitAbilityEditor(string FilePath, object[] Params)
            : this()
        {
        ...
        public override EditorInfo[] LoadEditors()
        {
            ...
            {
                new EditorInfo(new string[] { GUIRootPathUnitAbilities }, "Units/Abilities/", new string[] { ".pes" }, typeof(ProjectEternityUnitAbilityEditor))
            };
