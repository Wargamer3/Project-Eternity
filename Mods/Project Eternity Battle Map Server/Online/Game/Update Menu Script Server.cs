...
namespace ProjectEternity.GameScreens.BattleMapScreen.Server
{
    public class UpdateMenuScriptServer : OnlineScript
    {
        ...
        protected override void Execute(IOnlineConnection Sender)
        {
            ...
            {
                if (SendBackToSender || ActiveGroup.Room.ListOnlinePlayer[P] != Sender)
                {
                    ActiveGroup.Room.ListOnlinePlayer[P].Send(new UpdateMenuScriptServer(PanelName, ArrayUpdateData));
                }
            }
        }
