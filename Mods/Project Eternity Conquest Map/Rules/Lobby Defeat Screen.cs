...
using static ProjectEternity.GameScreens.ConquestMapScreen.LobbyVictoryScreen;
...
namespace ProjectEternity.GameScreens.ConquestMapScreen
{
    public class LobbyDefeatScreen : GameScreen
    {
        ...
        public LobbyDefeatScreen(ConquestMap Owner, List<PlayerGains> ListPlayerGains)
        {
            this.Owner = Owner;
