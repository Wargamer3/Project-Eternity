...
namespace ProjectEternity.GameScreens.ConquestMapScreen
{
    class PERAttackPahtfinding
    {
        ...
        public PERAttackPahtfinding(ConquestMap Map, UnitConquest ActiveUnit)
        {
            this.Map = Map;
        ...
        public void ComputeAttackTargets()
        {
            ...
            MovementAlgorithmTile ActiveTerrain = Map.GetTerrain(ActiveUnit.Components);
            Vector3 StartPosition = ActiveUnit.Position + new Vector3(0.5f, 0.5f, 0.5f);
            ListAllAttackTerrain.Add(ActiveTerrain);

            //Start Right, go downward
            Vector2 TestedFinalPos = new Vector2(Map.MapSize.X + 0.5f, ActiveUnit.Position.Y + 0.5f);
            do
            {
            ...
            while (++TestedFinalPos.Y < ActiveUnit.Position.Y);
