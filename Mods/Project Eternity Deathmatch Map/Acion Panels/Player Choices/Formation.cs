    ...
    public class ActionPanelFormation : ActionPanelDeathmatch
    {
        ...
        public override void Draw(CustomSpriteBatch g)
        {
            ...
            if (ActiveSquad.UnitsAliveInSquad == 3)
            {
                ...
                GameScreen.DrawText(g, ActiveSquad.At(0).RelativePath, new Vector2(Col1X + 40, Y + 10), Color.White);
                g.Draw(ActiveSquad.At(1).SpriteMap, new Vector2(Col2X, Y + 2), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(1).RelativePath, new Vector2(Col2X + 40, Y + 10), Color.White);
                g.Draw(ActiveSquad.At(2).SpriteMap, new Vector2(Col3X, Y + 2), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(2).RelativePath, new Vector2(Col3X + 40, Y + 10), Color.White);
                //1, 3, 2
                g.Draw(ActiveSquad.At(0).SpriteMap, new Vector2(Col1X, Y + 2 + MenuCursorHeight), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(0).RelativePath, new Vector2(Col1X + 40, Y + 10 + MenuCursorHeight), Color.White);
                g.Draw(ActiveSquad.At(2).SpriteMap, new Vector2(Col2X, Y + 2 + MenuCursorHeight), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(2).RelativePath, new Vector2(Col2X + 40, Y + 10 + MenuCursorHeight), Color.White);
                g.Draw(ActiveSquad.At(1).SpriteMap, new Vector2(Col3X, Y + 2 + MenuCursorHeight), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(1).RelativePath, new Vector2(Col3X + 40, Y + 10 + MenuCursorHeight), Color.White);
                //2, 1, 3
                g.Draw(ActiveSquad.At(1).SpriteMap, new Vector2(Col1X, Y + 2 + MenuCursorHeight * 2), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(1).RelativePath, new Vector2(Col1X + 40, Y + 10 + MenuCursorHeight * 2), Color.White);
                g.Draw(ActiveSquad.At(0).SpriteMap, new Vector2(Col2X, Y + 2 + MenuCursorHeight * 2), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(0).RelativePath, new Vector2(Col2X + 40, Y + 10 + MenuCursorHeight * 2), Color.White);
                g.Draw(ActiveSquad.At(2).SpriteMap, new Vector2(Col3X, Y + 2 + MenuCursorHeight * 2), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(2).RelativePath, new Vector2(Col3X + 40, Y + 10 + MenuCursorHeight * 2), Color.White);
                //2, 3, 1
                g.Draw(ActiveSquad.At(1).SpriteMap, new Vector2(Col1X, Y + 2 + MenuCursorHeight * 3), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(1).RelativePath, new Vector2(Col1X + 40, Y + 10 + MenuCursorHeight * 3), Color.White);
                g.Draw(ActiveSquad.At(2).SpriteMap, new Vector2(Col2X, Y + 2 + MenuCursorHeight * 3), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(2).RelativePath, new Vector2(Col2X + 40, Y + 10 + MenuCursorHeight * 3), Color.White);
                g.Draw(ActiveSquad.At(0).SpriteMap, new Vector2(Col3X, Y + 2 + MenuCursorHeight * 3), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(0).RelativePath, new Vector2(Col3X + 40, Y + 10 + MenuCursorHeight * 3), Color.White);
                //3, 1, 2
                g.Draw(ActiveSquad.At(2).SpriteMap, new Vector2(Col1X, Y + 2 + MenuCursorHeight * 4), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(2).RelativePath, new Vector2(Col1X + 40, Y + 10 + MenuCursorHeight * 4), Color.White);
                g.Draw(ActiveSquad.At(0).SpriteMap, new Vector2(Col2X, Y + 2 + MenuCursorHeight * 4), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(0).RelativePath, new Vector2(Col2X + 40, Y + 10 + MenuCursorHeight * 4), Color.White);
                g.Draw(ActiveSquad.At(1).SpriteMap, new Vector2(Col3X, Y + 2 + MenuCursorHeight * 4), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(1).RelativePath, new Vector2(Col3X + 40, Y + 10 + MenuCursorHeight * 4), Color.White);
                //3, 2, 1
                g.Draw(ActiveSquad.At(2).SpriteMap, new Vector2(Col1X, Y + 2 + MenuCursorHeight * 5), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(2).RelativePath, new Vector2(Col1X + 40, Y + 10 + MenuCursorHeight * 5), Color.White);
                g.Draw(ActiveSquad.At(1).SpriteMap, new Vector2(Col2X, Y + 2 + MenuCursorHeight * 5), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(1).RelativePath, new Vector2(Col2X + 40, Y + 10 + MenuCursorHeight * 5), Color.White);
                g.Draw(ActiveSquad.At(0).SpriteMap, new Vector2(Col3X, Y + 2 + MenuCursorHeight * 5), Color.White);
                GameScreen.DrawText(g, ActiveSquad.At(0).RelativePath, new Vector2(Col3X + 40, Y + 10 + MenuCursorHeight * 5), Color.White);
            ...
            else if (ActiveSquad.UnitsAliveInSquad == 2)
            {
                ...
                GameScreen.DrawText(g, Unit1.RelativePath, new Vector2(Col1X + 40, Y + 10), Color.White);
                g.Draw(Unit2.SpriteMap, new Vector2(Col2X, Y + 2), Color.White);
                GameScreen.DrawText(g, Unit2.RelativePath, new Vector2(Col2X + 40, Y + 10), Color.White);
                //2, 0
                g.Draw(Unit2.SpriteMap, new Vector2(Col1X, Y + 2 + MenuCursorHeight), Color.White);
                GameScreen.DrawText(g, Unit2.RelativePath, new Vector2(Col1X + 40, Y + 10 + MenuCursorHeight), Color.White);
                g.Draw(Unit1.SpriteMap, new Vector2(Col2X, Y + 2 + MenuCursorHeight), Color.White);
                GameScreen.DrawText(g, Unit1.RelativePath, new Vector2(Col2X + 40, Y + 10 + MenuCursorHeight), Color.White);
