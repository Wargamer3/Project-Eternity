        ...
        protected override void Execute(IOnlineConnection Sender)
        {
            foreach (BattleMapPlayer ActivePlayer in Owner.ListRoomPlayer)
            {
                if (ActivePlayer.ConnectionID == ID)
                {
                    ...
                    {
                        Unit Leader = PlayerManager.DicUnitType[ActiveSquad.ArrayUnit[0].UnitTypeName].FromFile(ActiveSquad.ArrayUnit[0].RelativePath, GameScreen.ContentFallback, PlayerManager.DicRequirement, PlayerManager.DicEffect, PlayerManager.DicAutomaticSkillTarget);
                        ...
                        {
                            Leader.ArrayCharacterActive[C] = new Core.Characters.Character(ActiveSquad.ArrayUnit[0].ArrayCharacter[C], GameScreen.ContentFallback, PlayerManager.DicRequirement, PlayerManager.DicEffect, PlayerManager.DicAutomaticSkillTarget, PlayerManager.DicManualSkillTarget);
                        ...
                        {
                            WingmanA = PlayerManager.DicUnitType[ActiveSquad.ArrayUnit[1].UnitTypeName].FromFile(ActiveSquad.ArrayUnit[1].RelativePath, GameScreen.ContentFallback, PlayerManager.DicRequirement, PlayerManager.DicEffect, PlayerManager.DicAutomaticSkillTarget);
                            ...
                            {
                                WingmanA.ArrayCharacterActive[C] = new Core.Characters.Character(ActiveSquad.ArrayUnit[1].ArrayCharacter[C], GameScreen.ContentFallback, PlayerManager.DicRequirement, PlayerManager.DicEffect, PlayerManager.DicAutomaticSkillTarget, PlayerManager.DicManualSkillTarget);
                            }
                        }
                        ...
                        {
                            WingmanB = PlayerManager.DicUnitType[ActiveSquad.ArrayUnit[2].UnitTypeName].FromFile(ActiveSquad.ArrayUnit[2].RelativePath, GameScreen.ContentFallback, PlayerManager.DicRequirement, PlayerManager.DicEffect, PlayerManager.DicAutomaticSkillTarget);
                            ...
                            {
                                WingmanB.ArrayCharacterActive[C] = new Core.Characters.Character(ActiveSquad.ArrayUnit[2].ArrayCharacter[C], GameScreen.ContentFallback, PlayerManager.DicRequirement, PlayerManager.DicEffect, PlayerManager.DicAutomaticSkillTarget, PlayerManager.DicManualSkillTarget);
                            }
                        }

                        ActivePlayer.Inventory.ActiveLoadout.ListSpawnSquad.Add(new Squad("", Leader, WingmanA, WingmanB));
                    }
                }
            }
        }
