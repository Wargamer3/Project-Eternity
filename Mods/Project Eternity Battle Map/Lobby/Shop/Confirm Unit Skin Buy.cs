...
{
    public class ShopConfirmBuyUnitSkinScreen : GameScreen
    {
        ...
        private UnlockableUnitSkin UnitSkinToBuy;
        ...
        public ShopConfirmBuyUnitSkinScreen(BattleMapPlayerInventory Inventory, string OwnerUnitTypeAndRelativePath, UnlockableUnitSkin UnitSkinToBuy)
        {
            this.Inventory = Inventory;
            this.OwnerUnitTypeAndRelativePath = OwnerUnitTypeAndRelativePath;
            this.UnitSkinToBuy = UnitSkinToBuy;
        ...
        public override void Draw(CustomSpriteBatch g)
        {
            ...
            g.Draw(UnitSkinToBuy.UnitSkinToBuy.SpriteMap, new Vector2(DrawX + MenuSizeX / 2 - UnitSkinToBuy.UnitSkinToBuy.SpriteMap.Width / 2, DrawY + 70), Color.White);

            g.DrawStringCentered(fntArial12, UnitSkinToBuy.UnitSkinToBuy.ItemName.ToUpper(), new Vector2(DrawX + MenuSizeX / 2, DrawY + 135), Color.White);

            g.DrawStringCentered(fntArial12, UnitSkinToBuy.UnitSkinToBuy.Price + " cr", new Vector2(DrawX + MenuSizeX / 2, DrawY + 175), Color.White);

            DrawSelectedUnitStats(g, DrawX + 20, DrawY + 220, UnitSkinToBuy.UnitSkinToBuy);
