...
namespace ProjectEternity.GameScreens.BattleMapScreen
{
    class InventoryCharacterScreen : GameScreen
    {
        ...
        public override void Draw(CustomSpriteBatch g)
        {
            ...
            {
                DrawBox(g, new Vector2(5, DrawY), BattleMapInventoryScreen.LeftSideWidth - 10, 90, Color.White);
            ...
            for (int i = 0; i < Owner.ActivePlayer.Inventory.ListOwnedCharacter.Count; ++i)
            {
