...
{
    public class EmptyDropDownButton: IUIElement
    {
        ...
        public EmptyDropDownButton(Rectangle ButtonCollsionBox, SpriteFont fntText, string Text, string[] Choices, OnOver OnOverDelegate, OnClick OnClickDelegate)
        {
