...
{
    public class ShopConfirmBuyCardScreen : GameScreen
    {
        ...
        private UnlockableCard CardToBuy;
        ...
        public ShopConfirmBuyCardScreen(SorcererStreetInventory Inventory, UnlockableCard CardToBuy)
        {
        ...
        private void BuyUnit()
        {
            ...
            {
                Inventory.GlobalBook.DicCardsByType[CardToBuy.CardToBuy.CardType][CardToBuy.CardToBuy.Path].QuantityOwned++;
            }
            else
            {
                Inventory.GlobalBook.DicCardsByType[CardToBuy.CardToBuy.CardType].Add(CardToBuy.CardToBuy.Path, new CardInfo(CardToBuy.CardToBuy, 1));
            }
