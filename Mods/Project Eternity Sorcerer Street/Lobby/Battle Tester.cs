...
namespace ProjectEternity.GameScreens.SorcererStreetScreen
{
    public class BattleTesterScreen : GameScreen
    {
        ...
        public void DrawSetupMenu(CustomSpriteBatch g)
        {
            ...
            g.DrawStringCentered(fntMenuText, "Setup", new Vector2(X + SetupMenuWidth / 2, Y + HeaderHeight / 2), SorcererStreetMap.TextColor);

            Y += HeaderHeight;
            DrawBox(g, new Vector2(X, Y), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Creature", new Vector2(X + 5, Y + 1), SorcererStreetMap.TextColor);

            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Item", new Vector2(X + 5, Y + 1), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Enchant", new Vector2(X + 5, Y + 1), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Player Enchant", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Player Cards in hand", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Player Cards in deck", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader HP", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Max HP", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader ST", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Support ST Bonus", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Air Lands", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Earth Lands", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Fire Lands", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Water Lands", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Rank", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Gold", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Lap", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Invader Map Creatures", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            ...
            Y += HeaderHeight;
            DrawBox(g, new Vector2(X, Y), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Creature", new Vector2(X + 5, Y + 1), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Item", new Vector2(X + 5, Y + 1), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Enchant", new Vector2(X + 5, Y + 1), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Player Enchant", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Player Cards in hand", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Player Cards in deck", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender HP", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Max HP", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender ST", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Terrain HP Bonus", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Support ST Bonus", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Air Lands", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Earth Lands", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Fire Lands", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Water Lands", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Rank", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Gold", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Defender Map Creatures", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Current Lap", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Current Round", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
            DrawBox(g, new Vector2(X + SetupMenuWidth, Y), ButtonsWidth, ButtonHeight, Color.White);
            DrawBox(g, new Vector2(X, Y += ButtonHeight), SetupMenuWidth, ButtonHeight, Color.White);
            g.DrawString(fntMenuText, "Terrain Type", new Vector2(X + 5, Y), SorcererStreetMap.TextColor);
        }
        ...
        public void DrawPhaseSelectionMenu(CustomSpriteBatch g)
        {
            ...
            g.DrawStringCentered(fntMenuText, "Phases", new Vector2(X + PhasesMenuWidth / 2, Y + HeaderHeight / 2), SorcererStreetMap.TextColor);
