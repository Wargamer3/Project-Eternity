...
{
    public class ActionPanelUpdatePERAttacks : ActionPanelSorcererStreet
    {
        ...
        public ActionPanelUpdatePERAttacks(SorcererStreetMap Map)
            : base(PanelName, Map)
        {
            TimeElapsed = 0;
        ...
        public ActionPanelUpdatePERAttacks(SorcererStreetMap Map, List<PERAttack> ListNewPERAttack)
            : base(PanelName, Map)
        {
            TimeElapsed = 0;
            ListPERAttackToUpdate = new List<PERAttackMovement>();
        ...
        public void SetAttackContext(PERAttack ActiveAttackBox, SorcererStreetUnit AttackOwner, Vector3 Angle, Vector3 Position)
        {
            Map.SorcererStreetParams.GlobalAttackContext.Owner = AttackOwner;
            Map.SorcererStreetParams.GlobalAttackContext.OwnerProjectile = ActiveAttackBox;
            Map.SorcererStreetParams.GlobalAttackContext.OwnerSandbox = Map;
            Map.SorcererStreetParams.AttackParams.SharedParams.OwnerAngle = Angle;
            Map.SorcererStreetParams.AttackParams.SharedParams.OwnerPosition = Position;
        }
        ...
        public override void DoUpdate(GameTime gameTime)
        {
            ...
            else
            {
                ...
                for (int P = ListPERAttackToUpdate.Count - 1; P >= 0; --P)
                {
                    ...
                    if (ActiveAttack.Owner.PERAttributes.AffectedByGravity && !ActiveAttack.Owner.IsOnGround)
                    {
