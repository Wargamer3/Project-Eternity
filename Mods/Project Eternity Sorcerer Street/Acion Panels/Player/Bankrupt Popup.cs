...
{
    public class ActionPanelBankruptPopup : ActionPanelSorcererStreet
    {
        private const string PanelName = "PanelBankruptPopup";

        private int ActivePlayerIndex;
        private Player ActivePlayer;
        private double AITimer;

        public ActionPanelBankruptPopup(SorcererStreetMap Map)
            : base(PanelName, Map, false)
        {
        }

        public ActionPanelBankruptPopup(SorcererStreetMap Map, int ActivePlayerIndex)
            : base(PanelName, Map, false)
        {
        ...
        public override void Draw(CustomSpriteBatch g)
        {
            ...
            g.DrawStringMiddleAligned(Map.fntMenuText, "You are out of mana, sell territories to continue.", new Vector2(BoxX + BoxWidth / 2, (int)(BoxY + 16 * Ratio)), Color.White);
