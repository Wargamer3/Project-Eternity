...
namespace ProjectEternity.GameScreens.SorcererStreetScreen.Online
{
    public class JoinRoomLocalScriptClient : OnlineScript, DelayedExecutableOnlineScript
    {
        ...
        protected override void Execute(IOnlineConnection Host)
        {
            ...
            DicNewGameServerScript.Add(ChangePlayerTypeScriptClient.ScriptName, new ChangePlayerTypeScriptClient(NewRoom, NewPreparationScreen));
            ...
            {
                Host.Send(new AskChangBookScriptClient(ActivePlayer.ConnectionID, ActivePlayer.Inventory.CharacterModelPath, ActivePlayer.Inventory.ActiveBook));
            }
