...
{
    public class EffectActivationAllEnemies : AutomaticDeathmatchTargetType
    {
        public static string Name = "All Enemies";

        public EffectActivationAllEnemies()
            : this(null)
        {
        }

        public EffectActivationAllEnemies(DeathmatchContext GlobalContext)
        ...
        {
            return new EffectActivationAllEnemies(GlobalContext);
        }
    }
}
