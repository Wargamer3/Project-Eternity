...
namespace ProjectEternity.GameScreens.DeathmatchMapScreen
{
    ...
    {
        public class ScriptSpawnTransformingUnitFast : DeathmatchMapScript
        {
            private ScriptSpawnSquadHelper UnitSpawner;
            private ScriptUnit Leader;
            private int _TransformationIndex;
            private bool HasSpawned;

            public ScriptSpawnTransformingUnitFast()
                : this(null)
            {
            }
            ...
            {
                return new ScriptSpawnTransformingUnitFast(Map);
            }
