...
namespace ProjectEternity.GameScreens.DeathmatchMapScreen
{
    ...
    {
        public class ScriptSpawnSquad4Fast : DeathmatchMapScript
        {
            ...
            public ScriptSpawnSquad4Fast()
                : this(null)
            {
            }

            public ScriptSpawnSquad4Fast(DeathmatchMap Map)
                : base(Map, 140, 70, "Spawn Squad 4 Fast", new string[] { "Spawn" }, new string[] { "Timer Ended", "Animation Ended", "SFX Ended" })
            {
            ...
            public override void ExecuteTrigger(int Index)
            {
                if (!IsActive && !IsEnded)
                {
                    ...
                    if (!string.IsNullOrEmpty(WingmanC.SpawnUnitName))
                        UnitSpawner.WingmanCToSpawn = WingmanC;
            ...
            public override void Save(BinaryWriter BW)
            {
                ...
                WingmanB.Save(BW);
                BW.Write(WingmanC.ID);
                WingmanC.Save(BW);
            }

            protected override CutsceneScript DoCopyScript()
            {
                return new ScriptSpawnSquad4Fast(Map);
            }
            ...
            CategoryAttribute("Unit Attributes"),
            DescriptionAttribute(".")]
            public string WingmanCUnitName
            {
                get
                {
                    return WingmanC.SpawnUnitName;
                }
                set
                {
                    WingmanC.SpawnUnitName = value;
                }
            }

            [CategoryAttribute("Unit Attributes"),
            DescriptionAttribute(".")]
            public int WingmanCUnitStatsUpgrade
            {
                get
                {
                    return WingmanC.SpawnUnitStatsUpgrade;
                }
                set
                {
                    WingmanC.SpawnUnitStatsUpgrade = value;
                }
            }

            [CategoryAttribute("Unit Attributes"),
            DescriptionAttribute(".")]
            public int WingmanCUnitAttackUpgrade
            {
                get
                {
                    return WingmanC.SpawnUnitAttackUpgrade;
                }
                set
                {
                    WingmanC.SpawnUnitAttackUpgrade = value;
                }
            }

            [CategoryAttribute("Unit Attributes"),
            DescriptionAttribute(".")]
            public int WingmanCCharacterLevel
            {
                get
                {
                    return WingmanC.SpawnCharacterLevel;
                }
                set
                {
                    if (value < 1)
                        WingmanC.SpawnCharacterLevel = 1;
                    else
                        WingmanC.SpawnCharacterLevel = value;
                }
            }
            ...
            CategoryAttribute("Unit Attributes"),
            DescriptionAttribute(".")]
            public string[] WingmanCCharacter
            {
                get
                {
                    return WingmanC.SpawnCharacter;
                }
                set
                {
                    WingmanC.SpawnCharacter = value;
                }
            }

            [CategoryAttribute("Unit Attributes"),
            DescriptionAttribute("Destroy the Unit after the mission is completed. If true, this Unit will not be allowed to be used outside of the active Battle Map.")]
            public bool WingmanCDeleteAfterMission
            {
                get
                {
                    return WingmanC.DeleteAfterMission;
                }
                set
                {
                    WingmanC.DeleteAfterMission = value;
                }
            }
