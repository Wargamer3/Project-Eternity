...
namespace ProjectEternity.GameScreens.TripleThunderScreen
{
    public class BattleSelect : GameScreen, IMissionSelect
    {
        ...
        public override void Load()
        {
            ...
            {
                ActivePlayer.CharacterPreview = new RobotAnimation("Characters/" + ActivePlayer.Equipment.CharacterType, null, Vector2.Zero, 0, new PlayerInventory(), new MuteSFXGenerator(), new List<Weapon>());
            }
        }
        ...
        public void AddPlayer(Player NewPlayer)
        {
            ...
            NewPlayer.CharacterPreview = new RobotAnimation("Characters/" + NewPlayer.Equipment.CharacterType, null, Vector2.Zero, 0, new PlayerInventory(), new MuteSFXGenerator(), new List<Weapon>());
        ...
        public void UpdateCharacter(Player PlayerToUpdate)
        {
            ...
            PlayerToUpdate.CharacterPreview = new RobotAnimation("Characters/" + PlayerToUpdate.Equipment.CharacterType, null, Vector2.Zero, 0, new PlayerInventory(), new MuteSFXGenerator(), new List<Weapon>());
        }
