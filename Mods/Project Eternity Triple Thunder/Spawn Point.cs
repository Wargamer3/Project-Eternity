...
namespace ProjectEternity.GameScreens.TripleThunderScreen
{
    ...
    public class PlayerSpawnPoint : SpawnPoint
    {
        ...
        {
            RobotAnimation NewRobot = new RobotAnimation("Players/" + NewPlayer.Equipment.CharacterType, Owner, SpawnLocation, Team, NewPlayer.Equipment, PlayerSFXGenerator, new List<Weapon>());
