...
namespace ProjectEternity.GameScreens.BattleMapScreen
{
    public sealed class AmmoRegenEffect : SkillEffect
    {
        ...
        protected override string DoExecuteEffect()
        {
            ...
            {
                byte EvaluationValue = (byte)double.Parse(EvaluationResult, CultureInfo.InvariantCulture);

                foreach (Core.Attacks.Attack ActiveAttack in Params.LocalContext.EffectTargetUnit.ListAttack)
                {
                    ActiveAttack.IncreaseAmmo(EvaluationValue);
                }
            ...
            else if (_NumberType == Operators.NumberTypes.Relative)
            {
                ...
                foreach (Core.Attacks.Attack ActiveAttack in Params.LocalContext.EffectTargetUnit.ListAttack)
                {
                    ActiveAttack.IncreaseAmmo((byte)Math.Round(ActiveAttack.MaxAmmo * EvaluationValue));
                }
