...
namespace ProjectEternity.GameScreens.SorcererStreetScreen
{
    public sealed class SetCreatureCostEffect : SorcererStreetEffect
    {
        ...
        {
            Params.GlobalPlayerContext.ActivePlayer.GetCurrentAbilities(SorcererStreetBattleContext.EffectActivationPhases.Enchant).CreatureCostMultiplier = CreatuteCostMultiplier;
            return null;
        }
