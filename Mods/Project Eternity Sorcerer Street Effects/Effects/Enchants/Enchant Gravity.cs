...
{//All Players' next die roll yields a 1.
    public sealed class EnchantGravityEffect : SorcererStreetEffect
    {
        ...
        protected override string DoExecuteEffect()
        {
            ...
            NewGravityEffect.Lifetime[0].LifetimeType = SkillEffect.LifetimeTypeTurns;
            NewGravityEffect.Lifetime[0].LifetimeTypeValue = 2;
            Params.GlobalPlayerContext.ActivePlayer.Enchant = EnchantHelper.CreatePassiveEnchant(Name, NewGravityEffect, IconHolder.Icons.sprPlayerMovement);
            return "Gravity";
        }
