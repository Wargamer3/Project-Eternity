...
namespace Project_Eternity
{
    public sealed class Forge : GameScreen
    {
        ...
        public override void Load()
        {
            ...
            sprBackground = Content.Load<Texture2D>("Intermission Screens/Forge");
            ...
            //MainFilter.ListFilter[0].ListItem.Add(new Blueprints("Some Blueprint", "Create something", 1000, new List<Blueprints.ItemRequirement>(), PartHead.ListPartHead[0]));
