...
namespace Project_Eternity
{
    class ModelViewer : GameScreen
    {
        ...
        public override void Draw(SpriteBatch g)
        {
            ...
            g.GraphicsDevice.DepthStencilState = new DepthStencilState() { DepthBufferEnable = true };
            ...
            g.Begin();
            g.DrawString(Game.fntArial, "Hello fucking xna", new Vector2(50, 50), Color.White);
        }
    }
}
